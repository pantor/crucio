		...
		<div class="wrap">
			...
			<div class="container-light-grey container-padding-4">
				<div class="container container-text container-text-dark">
                    ...
                    <button class="btn btn-success btn-lg btn-green" ng-click="register()">
                        <i ng-show="is_working" class="fa fa-circle-o-notch fa-spin" style="color:white;"></i> Registrieren
                    </button>
                 </div>
			</div>
		</div>
