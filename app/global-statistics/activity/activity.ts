class GlobalStatisticActivityController {
  API: API;
...
angular.module('crucioApp').component('globalstatisticactivitycomponent', {
  templateUrl: 'app/global-statistics/activity/activity.html',
  controller: GlobalStatisticActivityController,
});
